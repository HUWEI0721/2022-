...
void input_pure_decimal(char pure_decimal[])
{
	...
	while (1)
	{
		...
		else if (a == '.')
		{
			for (i = 1; i < N_NUM; i++)
			{
				...
				if (pure_decimal[i] != '1' && pure_decimal[i] != '0' && pure_decimal[i] != '\0')
				{
	...
	cout << endl;
	pure_decimal[0] = 1;
	for (int t = N_NUM; t >= 0; t--)
	{
		if (pure_decimal[t] != '0' && pure_decimal[t] != '\0')
		{
			pure_decimal[0] = t;
			break;
		}
